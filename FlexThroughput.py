def flex_through():
    ...
    for sheet_ranges in shift_notes.worksheets:
        ...
        try:
            ...
            afternoons_f2_list.append(0)
        afternoons_f2_list.insert(3,d_f2_cup_sum)
        ...
        try:
            ...
            afternoons_f3_list.append(0)
        afternoons_f3_list.insert(3,d_f2_cup_sum)
    ...
    current_tracking_book.save('flex throughput nonsense\Flex Throughput ' +month+'.xlsx')

    print("Flex Throughput "+month+".xlsx Created")
